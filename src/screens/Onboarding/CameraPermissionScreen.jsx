...
//           console.log('Camera permission granted! Navigating to Microphone Permission Screen.');
...
//         { text: "Skip", onPress: () => navigation.navigate('MicrophonePermission') }
//       ]
//     );
//   };
...
const CameraPermissionScreen = () => {
  return (
    <View>
      <Text>CameraPermissionScreen</Text>
    </View>
  )
}
